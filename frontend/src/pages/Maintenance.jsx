...
const Maintenance = () => {
  ...
  const schedules = filterMaintenanceSchedules({
    ...filters,
    startDate,
    endDate,
  })
  ...
  const handleStatusChange = (scheduleId, newStatus) => {
    updateMaintenanceSchedule(scheduleId, { status: newStatus })
  }
                  ...
                  <div className="flex-1">
                    ...
                    {schedule.assignedTo && (
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">Assigned to User</span>
                      </div>
                    )}
                  </div>
